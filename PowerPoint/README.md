...
#### 使用幻灯片母版 <a id="motherboard"></a> <a id="h4-2-1"></a>
...
#### 使用超链接通过点击元素在幻灯片间跳转 <a id="h4-2-2"></a>
...
#### 快速调节文字大小 <a id="h4-2-7"></a>

使用快捷键``Ctrl``+``]``增大文字字号，使用快捷键``Ctrl``+``[``减小文字字号。

#### 使用图层窗口 <a id="h4-2-8"></a>
...
## 动画或切换编辑相关 <a id="h2-4"></a>

#### 添加动画实现题目答案显示 <a id="h4-4-1"></a>
...
#### 使用动态内容切换更直观地展示幻灯片间的关系 <a id="h4-4-6"></a>
